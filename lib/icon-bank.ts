...
import { Bot, Camera, Leaf, Map as MapIcon, Users } from "lucide-react";
...
export const FILE_ICONS: FileIcon[] = [
	...
	{
		label: "AI Report Maker",
		path: "/logo/AiReportMaker.svg",
		category: "logo",
	},
...
export const LUCIDE_ICONS: LucideIconEntry[] = [
	...
	{ id: "lucide:Map", label: "Géographie", component: MapIcon },
